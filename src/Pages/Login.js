            ...
            <div className="lg:w-1/3">
                ...
                <form className="p-5 shadow-md bg-white rounded-lg" onSubmit={(e) => Submit(e)}>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="" className="w-full p-2 rounded mt-3 mb-5" onChange={(e) => setUserDetails({ ...userDetails, username: e.target.value })} />
                    </div>
                    <div>
                        <label htmlFor="password">
                            ENTER YOUR PASSWORD
                    </label>
                        <input type="password" name="password" id="" className="w-full p-2 rounded mt-3 mb-5" onChange={(e) => { setUserDetails({ ...userDetails, password: e.target.value }) }} />
                    </div>
